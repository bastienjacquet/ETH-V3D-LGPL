...
/**
  * This program generates a .features file for each images in <image list file>
  * @param <image list file> list of image filenames
  * @param <min. octave> minimum octave (scale) for selecting feature points
  * @param <DoG threshold> Derivative of Gaussian threshold to select a point as point of interest
  * @param <silhouette images list file> (optional) mask file [PNM,JPG,PNG] with interest region > 127
 */
int main(int argc, char * argv[])
{
   ...
   try
   {
      ...
      siftArgs.push_back("-maxd"); siftArgs.push_back("10000");
      //-fo -1	use -1 octave 
