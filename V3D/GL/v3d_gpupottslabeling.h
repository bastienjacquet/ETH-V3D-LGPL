...
namespace V3D_GPU
{
   ...
   struct PottsLabeling3_Relaxed
   {
         PottsLabeling3_Relaxed()
            : _width(-1), _height(-1), _theta(0.1f), _timestep(0.249f), _epsilon(0.0f)
      ...
      protected:
         ...
         float _theta, _timestep, _epsilon;
...
//======================================================================
   ...
   struct PottsLabeling3_Huber_FwBw
   {
         PottsLabeling3_Huber_FwBw()
            : _width(-1), _height(-1), _tau(0.249f), _epsilon(0.1f)
         {
            _uBufA = new RTT_Buffer("rgb=32f", "PottsLabeling3_Huber_FwBw::uBufA");
            _uBufB = new RTT_Buffer("rgb=32f", "PottsLabeling3_Huber_FwBw::uBufB");
         }
         ...
         void setTimestep(float tau) { _tau = tau; }
         void setEpsilon(float eps) { _epsilon = eps; }

         void setZero();
         void copyBuffersFrom(PottsLabeling3_Huber_FwBw& src);
         void iterate(unsigned int costTexId, int nIterations);
      ...
      protected:
         ...
         RTT_Buffer * _uBufA;
         RTT_Buffer * _uBufB;
   }; // end struct PottsLabeling3_Huber_FwBw
