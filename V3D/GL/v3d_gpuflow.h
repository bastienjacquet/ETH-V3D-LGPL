...
//----------------------------------------------------------------------
   ...
   struct StructureL1_FlowEstimator_PD : public TVL1_FlowEstimatorBase
   {
      public:
         struct Config
         {
         ...
         StructureL1_FlowEstimator_PD(int nLevels)
            : TVL1_FlowEstimatorBase(nLevels)
         {
         ...
         unsigned int getFlowFieldTextureID() { return _uBuffer2Pyramid[_startLevel]->textureID(); }
         unsigned int getAlphaXTextureID()    { return _alpha1Tex2Pyramid[_startLevel]->textureID(); }
         unsigned int getAlphaYTextureID()    { return _alpha2Tex2Pyramid[_startLevel]->textureID(); }
         unsigned int getBetaXTextureID()     { return _beta1Tex1Pyramid[_startLevel]->textureID(); }
         unsigned int getBetaYTextureID()     { return _beta2Tex1Pyramid[_startLevel]->textureID(); }
      ...
      protected:
         ...
         std::vector<ImageTexture2D *> _alpha1Tex1Pyramid, _alpha1Tex2Pyramid;
         std::vector<ImageTexture2D *> _alpha2Tex1Pyramid, _alpha2Tex2Pyramid;

         // We do not need to double the beta buffers, since there is no ping-pong rendering applied on those
         //std::vector<ImageTexture2D *> _beta1TexPyramid, _beta2TexPyramid;
         std::vector<ImageTexture2D *> _beta1Tex1Pyramid, _beta2Tex1Pyramid;
         //std::vector<ImageTexture2D *> _beta1Tex2Pyramid, _beta2Tex2Pyramid;
         std::vector<FrameBufferObject *> _alpha1Fbo1Pyramid, _alpha1Fbo2Pyramid;
         std::vector<FrameBufferObject *> _alpha2Fbo1Pyramid, _alpha2Fbo2Pyramid;

         std::vector<RTT_Buffer *> _p1Buffer1Pyramid, _p1Buffer2Pyramid;
         std::vector<RTT_Buffer *> _p2Buffer1Pyramid, _p2Buffer2Pyramid;

         std::vector<RTT_Buffer *> _q1hBuffer1Pyramid, _q1hBuffer2Pyramid;
         std::vector<RTT_Buffer *> _q1vBuffer1Pyramid, _q1vBuffer2Pyramid;

         std::vector<RTT_Buffer *> _q2hBuffer1Pyramid, _q2hBuffer2Pyramid;
         std::vector<RTT_Buffer *> _q2vBuffer1Pyramid, _q2vBuffer2Pyramid;
   }; // end struct StructureL1_FlowEstimator_PD
